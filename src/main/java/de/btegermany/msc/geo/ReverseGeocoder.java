...
/**
 * Copyright (C) 2015 Erich Schubert (kno10)
 * https://github.com/kno10/reversegeocode/blob/master/src/main/java/com/kno10/reversegeocode/query/ReverseGeocoder.java
 */
